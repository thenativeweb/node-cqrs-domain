 ...
 * @param {String} name    The aggregate name.
 * @param {String} id      The aggregate id.
 * @param {Number} version The aggregate version.
 * @constructor
 */
function AggregateModel (name, id, version) {
  if (!name || !_.isString(name)) {
    var err = new Error('No name injected!');
    debug(err);
    throw err;
  }
  ...
  if (version === undefined || version === null || !_.isNumber(version)) {
    var err = new Error('No version injected!');
    debug(err);
    throw err;
  }
