    ...
    getInfo: function () {
      ...
      ctxs.forEach(function (ctx) {
        ...
        ctx.aggregates.forEach(function (aggr) {
          var a = { name: aggr.name, version: aggr.version, commands: [], events: [], preConditions: [], businessRules: [] };

          aggr.commands.forEach(function (command) {
            a.commands.push({ name: command.name, version: command.version });
          });
          ...
          aggr.preConditions.forEach(function (preCond) {
            a.preConditions.push({ name: preCond.name, description: preCond.description });
          });

          aggr.businessRules.forEach(function (businessRule) {
            a.businessRules.push({ name: businessRule.name, description: businessRule.description });
          });
